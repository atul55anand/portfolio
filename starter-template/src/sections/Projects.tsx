...
export const ProjectsSection = () => {
  return <div>
    <div className="container">
      ...
      <h2 className="font-serif text-3xl text-centr mt-6">Featured Projects</h2>
      <p className="text-center text-white/60 mt-4">
        See How I transformed concepts into engaging digita expereinces
        </p>
      ...
      {portfolioProjects.map(project=>(
        ...
        ">
          <div className="flex">
            ...
            from-emerald-300 to-sky-400 inline-flex font-bold uppercase tracking-widest text-sm">
