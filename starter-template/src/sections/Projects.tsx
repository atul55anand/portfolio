...
export const ProjectsSection = () => {
  ...
  <section className="pb-16 lg:py-24">
    <div className="container">
      <SectionHeader eyebrow="Real-World-Results" title="Featured Projects" description="See How I transformed concepts into engaging digita expereinces"/>
      ...
      {portfolioProjects.map(project=>(
        ...
        ">
          ...
          lg:gap-16">
            ...
            from-emerald-300 to-sky-400 inline-flex gap-2 font-bold uppercase
